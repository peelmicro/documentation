...
![](PreviewOurCompletedApp.png)

![](PreviewOurCompletedApp2.png)

![](PreviewOurCompletedApp3.png)

![](PreviewOurCompletedApp4.png)

![](PreviewOurCompletedApp5.png)

![](PreviewOurCompletedApp6.png)

![](PreviewOurCompletedApp7.png)

![](PreviewOurCompletedApp8.png)

![](PreviewOurCompletedApp9.png)

![](PreviewOurCompletedApp10.png)

![](PreviewOurCompletedApp11.png)

![](PreviewOurCompletedApp12.png)

![](PreviewOurCompletedApp13.png)

### 2. Tools Used/Required 4min

- We are going to use [NodeJs](https://nodejs.org/en/).

![](ToolsUsedRequired.png)

- We are also going to use [Visual Studio Code](https://code.visualstudio.com/)

![](ToolsUsedRequired2.png)

- We'll be using [MongoDB Atlas](https://www.mongodb.com/cloud/atlas)

![](ToolsUsedRequired3.png)

- We'll also be using [Now — Global Serverless Deployments](https://zeit.co/now)

![](ToolsUsedRequired4.png)

- We'll be using [Chrome Canary](https://www.google.com/chrome/canary/)

![](ToolsUsedRequired5.png)

- We need to install `Vue.js devtools`

![](ToolsUsedRequired6.png)

![](ToolsUsedRequired7.png)
...
![](WhatIsGraphQLUsingTheSwapiGraphQL.png)
...
![](WhatIsGraphQLUsingTheSwapiGraphQL2.png)
...
![](WhatIsGraphQLUsingTheSwapiGraphQL3.png)

![](WhatIsGraphQLUsingTheSwapiGraphQL4.png)

![](WhatIsGraphQLUsingTheSwapiGraphQL5.png)

![](WhatIsGraphQLUsingTheSwapiGraphQL6.png)
...
![](GitCloneAndInstallDependencies.png)
...
![](AddingResolversAndExecutingQueriesInGraphQLPlayground.png)
...
![](AddingResolversAndExecutingQueriesInGraphQLPlayground2.png)

- We also can see `docs`

![](AddingResolversAndExecutingQueriesInGraphQLPlayground3.png)

![](AddingResolversAndExecutingQueriesInGraphQLPlayground4.png)
...
![](AddingResolversAndExecutingQueriesInGraphQLPlayground5.png)
...
![](WritingAndRunningFirstMutationInGraphQLPlayground.png)

![](WritingAndRunningFirstMutationInGraphQLPlayground2.png)
...
![](ExploringGraphQLPlayground6.png)

![](ExploringGraphQLPlayground7.png)
...
![](ExploringGraphQLPlayground8.png)
...
![](ExploringGraphQLPlayground9.png)

![](ExploringGraphQLPlayground10.png)
...
![](CreateMongoDBAtlasDatabaseConnectToGraphQLServer.png)

![](CreateMongoDBAtlasDatabaseConnectToGraphQLServer2.png)

- Connect to `cluster0`

![](CreateMongoDBAtlasDatabaseConnectToGraphQLServer3.png)

- Modify the `server.js` to remove

- Click on `Connect your Application`

![](CreateMongoDBAtlasDatabaseConnectToGraphQLServer4.png)

- Copy the connection String

![](CreateMongoDBAtlasDatabaseConnectToGraphQLServer5.png)
...
![](WriteAndRunSignupUserMutation.png)

![](WriteAndRunSignupUserMutation2.png)
...
![](WriteAndRunAddPostMutation.png)
...
![](CreateVueClientWithVueCli3.png)
...
![](CreateVueClientWithVueCli32.png)

![](CreateVueClientWithVueCli33.png)
...
![](CreateVueClientWithVueCli39.png)
...
![](CreateVueClientWithVueCli310.png)
...
![](AddingPluginsWithVueGuiAndConcurrentlyDevScript.png)

- If we click on `+Add plugin` we can see a list of available `plugins`

![](AddingPluginsWithVueGuiAndConcurrentlyDevScript2.png)

![](AddingPluginsWithVueGuiAndConcurrentlyDevScript3.png)

- We missed adding Vuex, so we can do it by clicking on `Add Vuex` button.

![](AddingPluginsWithVueGuiAndConcurrentlyDevScript4.png)

![](AddingPluginsWithVueGuiAndConcurrentlyDevScript5.png)

![](AddingPluginsWithVueGuiAndConcurrentlyDevScript6.png)
...
![](AddingPluginsWithVueGuiAndConcurrentlyDevScript7.png)
...
![](InstallingVuetifyPluginAndGeneratingATheme.png)
...
![](InstallingVuetifyPluginAndGeneratingATheme2.png)
...
![](InstallingVuetifyPluginAndGeneratingATheme3.png)

![](InstallingVuetifyPluginAndGeneratingATheme4.png)

![](InstallingVuetifyPluginAndGeneratingATheme5.png)

![](InstallingVuetifyPluginAndGeneratingATheme6.png)

![](InstallingVuetifyPluginAndGeneratingATheme7.png)

![](InstallingVuetifyPluginAndGeneratingATheme8.png)
...
![](InstallingVuetifyPluginAndGeneratingATheme9.png)
...
![](CoolorsCoForCreatingGreatColorSchemes.png)

![](CoolorsCoForCreatingGreatColorSchemes2.png)

![](CoolorsCoForCreatingGreatColorSchemes3.png)

![](CoolorsCoForCreatingGreatColorSchemes4.png)
...
![](HorizontalNavbarAndMobileFirstDesign.png)

![](HorizontalNavbarAndMobileFirstDesign2.png)

![](HorizontalNavbarAndMobileFirstDesign3.png)
...
![](AddRoutingAndPageTransitions.png)

![](AddRoutingAndPageTransitions2.png)

![](AddRoutingAndPageTransitions3.png)

![](AddRoutingAndPageTransitions4.png)

![](AddRoutingAndPageTransitions5.png)
...
![](DiveIntoSmartQueries2.png)

![](DiveIntoSmartQueries3.png)
...
![](DiveIntoSmartQueries5.png)

- We can get more information in [Apollo and GraphQL for Vue.js](https://github.com/Akryum/vue-apollo)

![](DiveIntoSmartQueries6.png)

![](DiveIntoSmartQueries7.png)

![](DiveIntoSmartQueries8.png)
...
![](ExecutingQueriesWithTheApolloQueryComponent.png)
...
![](ExecutingQueriesWithTheApolloQueryComponent2.png)
...
![](ExecutingQueriesWithTheApolloQueryComponent3.png)
...
![](AddCarouselComponentToHomePage.png)

![](AddCarouselComponentToHomePage2.png)
...
![](FiringGetPostsActionWithVuex.png)
...
![](AddLoadingPropertyLoadingSpinnerAndMapGetters.png)

![](AddLoadingPropertyLoadingSpinnerAndMapGetters2.png)
...
![](CreateGravatarAvatarAndHashUserPasswordsOnSignup.png)
...
![](CreateGravatarAvatarAndHashUserPasswordsOnSignup2.png)
...
![](UsingVariablesInGraphQLSigninSignupMutationDefs.png)
...
![](AddSigninFormWriteAndRunSigninUserActionReturnJwt.png)

![](AddSigninFormWriteAndRunSigninUserActionReturnJwt2.png)
...
![](AdditionalConfigForApolloClientSendTokenFromLocalStorage.png)
...
![](AdditionalConfigForApolloClientSendTokenFromLocalStorage2.png)

- If we send the proper credentials.

![](AdditionalConfigForApolloClientSendTokenFromLocalStorage3.png)
...
![](CreateGetCurrentUserQueryExecuteItFromMainJs.png)

![](CreateGetCurrentUserQueryExecuteItFromMainJs2.png)
...
![](RedirectHomeUponSigninWithWatcher.png)

- When the new user data is received it is redirected to the main page.

![](RedirectHomeUponSigninWithWatcher2.png)
...
![](ChangeNavbarForSignedInUser.png)

![](ChangeNavbarForSignedInUser2.png)

- After signing in:

![](ChangeNavbarForSignedInUser3.png)

![](ChangeNavbarForSignedInUser4.png)
...
![](CreateSignoutAction.png)

![](CreateSignoutAction2.png)

![](CreateSignoutAction3.png)

![](CreateSignoutAction4.png)
...
![](ProtectedRoutesAndClearingMalformedTokens.png)

![](ProtectedRoutesAndClearingMalformedTokens2.png)
...
![](AddingGlobalFormAlertComponent.png)
...
![](AddLoadingSpinnerToSigninButton.png)

![](AddLoadingSpinnerToSigninButton2.png)
...
![](FormValidationWithVuetifyInSigninComponent.png)

![](FormValidationWithVuetifyInSigninComponent2.png)

![](FormValidationWithVuetifyInSigninComponent3.png)

![](FormValidationWithVuetifyInSigninComponent4.png)
...
![](ShowAuthSnackbarOnSigninSignup.png)
...
![](HandleAuthenticationErrors.png)

![](HandleAuthenticationErrors2.png)

![](HandleAuthenticationErrors3.png)
...
![](CreateSignupFormAndSignupUserAction.png)

![](CreateSignupFormAndSignupUserAction2.png)

![](CreateSignupFormAndSignupUserAction3.png)

![](CreateSignupFormAndSignupUserAction4.png)

![](CreateSignupFormAndSignupUserAction5.png)
...
![](MakeAddPostForm2.png)

![](MakeAddPostForm3.png)

![](MakeAddPostForm4.png)

![](MakeAddPostForm5.png)
...
![](CreateAndExecuteAddPostActionMutation.png)

![](CreateAndExecuteAddPostActionMutation2.png)
...
![](UpdateAndOptimisticResponseForAddPostMutation.png)

![](UpdateAndOptimisticResponseForAddPostMutation2.png)
...
![](InfiniteScrollOnPostsPage2.png)
...
![](InfiniteScrollOnPostsPage3.png)
...
![](AddInfiniteScrollFunctionalityOnClient.png)

![](AddInfiniteScrollFunctionalityOnClient2.png)

![](AddInfiniteScrollFunctionalityOnClient3.png)
...
![](AddGridLayoutCardsforEachPostInPostsComponent.png)

![](AddGridLayoutCardsforEachPostInPostsComponent2.png)

![](AddGridLayoutCardsforEachPostInPostsComponent3.png)

![](AddGridLayoutCardsforEachPostInPostsComponent4.png)

![](AddGridLayoutCardsforEachPostInPostsComponent5.png)
...
![](CreatePostComponentAndRoute.png)

![](CreatePostComponentAndRoute2.png)

![](CreatePostComponentAndRoute3.png)

![](CreatePostComponentAndRoute4.png)
...
![](CreateAndExecuteGetPostQuery.png)

![](CreateAndExecuteGetPostQuery2.png)

![](CreateAndExecuteGetPostQuery3.png)
...
![](BuildOutPostCardInPostComponent.png)

![](BuildOutPostCardInPostComponent2.png)

![](BuildOutPostCardInPostComponent3.png)

![](BuildOutPostCardInPostComponent4.png)
...
![](AddMessagesSectionToPostComponent.png)
...
![](PerformAddPostMessageInPostComponent.png)

![](PerformAddPostMessageInPostComponent2.png)

- Now we sign in with another user.

![](PerformAddPostMessageInPostComponent3.png)

![](PerformAddPostMessageInPostComponent4.png)
...
![](AddValidationForMessageInput.png)

![](AddValidationForMessageInput2.png)

![](AddValidationForMessageInput3.png)

![](AddValidationForMessageInput4.png)

![](AddValidationForMessageInput5.png)
...
![](FiringLikeUnlikePostMutationsFromClient.png)

![](FiringLikeUnlikePostMutationsFromClient2.png)

![](FiringLikeUnlikePostMutationsFromClient3.png)

![](FiringLikeUnlikePostMutationsFromClient4.png)
...
![](AddLogicForTogglingLikeUnlikePost.png)

![](AddLogicForTogglingLikeUnlikePost2.png)

![](AddLogicForTogglingLikeUnlikePost3.png)
...
![](AddLikeNotificationInProfileTab.png)

![](AddLikeNotificationInProfileTab2.png)

![](AddLikeNotificationInProfileTab3.png)
...
![](FireSearchPostsActionLogSearchResults.png)

![](FireSearchPostsActionLogSearchResults2.png)

![](FireSearchPostsActionLogSearchResults3.png)
...
![](AddSearchResultsToStateBuildSearchResultCard.png)
...
![](FinishingSearchResultsMakingThemFunctional.png)

![](FinishingSearchResultsMakingThemFunctional2.png)

![](FinishingSearchResultsMakingThemFunctional3.png)

![](FinishingSearchResultsMakingThemFunctional4.png)
...
![](AddUserDetailsCardFavoritesCards.png)

![](AddUserDetailsCardFavoritesCards2.png)
...
![](ExecuteGetUserPostsQueryCreateAndPopulateUserCards.png)

![](ExecuteGetUserPostsQueryCreateAndPopulateUserCards2.png)
...
![](AddEditPostDialogForUpdatingUserPosts.png)

![](AddEditPostDialogForUpdatingUserPosts2.png)

![](AddEditPostDialogForUpdatingUserPosts3.png)
...
![](ExecutingUpdateUserPostMutationWithVuexAction.png)

![](ExecutingUpdateUserPostMutationWithVuexAction2.png)

![](ExecutingUpdateUserPostMutationWithVuexAction3.png)

![](ExecutingUpdateUserPostMutationWithVuexAction4.png)

![](ExecutingUpdateUserPostMutationWithVuexAction5.png)

![](ExecutingUpdateUserPostMutationWithVuexAction6.png)
...
![](DeleteUserRecipeMutationBackendCreationToFrontendExecution.png)

![](DeleteUserRecipeMutationBackendCreationToFrontendExecution2.png)

![](DeleteUserRecipeMutationBackendCreationToFrontendExecution3.png)
...
![](RefetchQueriesForFreshDataUponExecutingMutations.png)

![](RefetchQueriesForFreshDataUponExecutingMutations2.png)

![](RefetchQueriesForFreshDataUponExecutingMutations3.png)

![](RefetchQueriesForFreshDataUponExecutingMutations4.png)

![](RefetchQueriesForFreshDataUponExecutingMutations5.png)
...
![](FormattingDatesWithMoment.png)

![](FormattingDatesWithMoment2.png)

![](FormattingDatesWithMoment3.png)
...
![](MinorImprovementsFixes.png)

![](MinorImprovementsFixes2.png)

![](MinorImprovementsFixes3.png)

![](MinorImprovementsFixes4.png)

![](MinorImprovementsFixes5.png)

![](MinorImprovementsFixes6.png)
...
![](DeployingAppWithHerokuNowV2.png)

- Signup on `Now`

![](DeployingAppWithHerokuNowV22.png)

![](DeployingAppWithHerokuNowV23.png)

- We need to set up the Atlas `IP Whitelist`.

![](DeployingAppWithHerokuNowV24.png)
...
![](DeployingAppWithHerokuNowV27.png)
...
![](DeployingAppWithHerokuNowV28.png)
...
![](DeployingAppWithHerokuNowV29.png)
...
![](DeployingAppWithHerokuNowV30.png)
...
![](DeployingAppWithHerokuNowV31.png)
...
![](DeployingAppWithHerokuNowV33.png)

![](DeployingAppWithHerokuNowV34.png)
...
![](DeployingAppWithHerokuNowV35.png)
