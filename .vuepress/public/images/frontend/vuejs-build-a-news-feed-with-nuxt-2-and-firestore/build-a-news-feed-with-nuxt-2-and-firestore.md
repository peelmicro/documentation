...
![](CreateProjectWithCreateNuxtApp.png)
...
![](IntegrateVueMaterialWithApp.png)
...
![](IntegrateVueMaterialWithApp2.png)
...
![](IntegrateVueMaterialWithApp3.png)
...
![](ProxyAxiosRequestsWithNuxtProxyModule.png)
...
![](StyleHeadlinesWithCardComponents.png)
...
![](AddLoginRegisterPages.png)

![](AddLoginRegisterPages2.png)

![](AddLoginRegisterPages3.png)
...
![](AddLoginRegisterPages4.png)

![](AddLoginRegisterPages5.png)
...
![](CreateVuexStoreUseFetchToPutHeadlinesInStore.png)
...
![](SelectHeadlinesByNewsCategory.png)

![](SelectHeadlinesByNewsCategory2.png)

![](SelectHeadlinesByNewsCategory3.png)

![](SelectHeadlinesByNewsCategory4.png)
...
![](SelectHeadlinesByCountry.png)

![](SelectHeadlinesByCountry2.png)

![](SelectHeadlinesByCountry3.png)

![](SelectHeadlinesByCountry4.png)
...
![](RegisterNewUsersWithFirebaseRestApi.png)

- We are going to create a new `Firebase` project.

![](RegisterNewUsersWithFirebaseRestApi2.png)

- Put the `nuxt-news-feed` for the `Project-name`

![](RegisterNewUsersWithFirebaseRestApi3.png)

- We are going to use a project that already exists.

![](RegisterNewUsersWithFirebaseRestApi4.png)

![](RegisterNewUsersWithFirebaseRestApi5.png)
...
![](RegisterNewUsersWithFirebaseRestApi6.png)
...
![](RegisterNewUsersWithFirebaseRestApi7.png)
...
![](RegisterNewUsersWithFirebaseRestApi8.png)

- We need to test if the `register` page is working.

![](RegisterNewUsersWithFirebaseRestApi9.png)

![](RegisterNewUsersWithFirebaseRestApi10.png)

![](RegisterNewUsersWithFirebaseRestApi11.png)
...
![](DisableFormUponRegistrationRedirectHomeUponSuccessful.png)

![](DisableFormUponRegistrationRedirectHomeUponSuccessful2.png)
...
![](AddNavigationGuardsUsingMiddleware.png)

![](AddNavigationGuardsUsingMiddleware2.png)

![](AddNavigationGuardsUsingMiddleware3.png)
...
![](FormValidationWithVuelidate.png)

![](FormValidationWithVuelidate2.png)

![](FormValidationWithVuelidate3.png)

![](FormValidationWithVuelidate4.png)

![](FormValidationWithVuelidate5.png)
...
![](CreateAvatarUponRegisterAndDisplayUserDataInNavbar.png)

![](CreateAvatarUponRegisterAndDisplayUserDataInNavbar2.png)

![](CreateAvatarUponRegisterAndDisplayUserDataInNavbar3.png)
...
![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase.png)

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase2.png)

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase3.png)

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase4.png)

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase5.png)

- Add the `users` collection.

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase6.png)
...
![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase7.png)

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase8.png)

- We are going to delete the test data created.

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase9.png)

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase10.png)

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase11.png)

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase12.png)

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase13.png)
...
![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase14.png)

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase15.png)

![](SetupFirestoreAsAPluginAddUserDataToFirestoreDatabase16.png)
...
![](AddLoginFormFunctionality2.png)

![](AddLoginFormFunctionality3.png)
![](AddLoginFormFunctionality4.png)
...
![](ManageUserSessionsWithCookies.png)

![](ManageUserSessionsWithCookies2.png)

![](ManageUserSessionsWithCookies3.png)

![](ManageUserSessionsWithCookies4.png)

![](ManageUserSessionsWithCookies5.png)

![](ManageUserSessionsWithCookies6.png)

![](ManageUserSessionsWithCookies7.png)

![](ManageUserSessionsWithCookies8.png)

![](ManageUserSessionsWithCookies9.png)

![](ManageUserSessionsWithCookies10.png)
