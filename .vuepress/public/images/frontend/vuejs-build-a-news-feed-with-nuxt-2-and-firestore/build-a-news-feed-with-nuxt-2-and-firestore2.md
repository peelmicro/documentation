...
![](CreateAbilityToBookmarkHeadlines.png)
...
![](CreateAbilityToBookmarkHeadlines2.png)

- If there is not authentication, when we click the `bookmark` button nothing happens.

![](CreateAbilityToBookmarkHeadlines3.png)

![](CreateAbilityToBookmarkHeadlines4.png)

- If the use is authenticated, when we click the `bookmark` button the headline is stored in the `feeds` collection of the user.

![](CreateAbilityToBookmarkHeadlines5.png)

![](CreateAbilityToBookmarkHeadlines6.png)

![](CreateAbilityToBookmarkHeadlines7.png)

- If we refresh the page we can see the bookmark.

![](CreateAbilityToBookmarkHeadlines8.png)

![](CreateAbilityToBookmarkHeadlines9.png)
...
![](AddListenerOnSnapshotToPersonalFeed.png)

![](AddListenerOnSnapshotToPersonalFeed2.png)

- The headline is added without needing to refresh the page.

![](AddListenerOnSnapshotToPersonalFeed3.png)
...
![](AddMarkupForEmptyStateInPersonalFeed.png)

![](AddMarkupForEmptyStateInPersonalFeed2.png)

![](AddMarkupForEmptyStateInPersonalFeed3.png)
...
![](DeleteHeadlinesFromPersonalFeed.png)

![](DeleteHeadlinesFromPersonalFeed2.png)

![](DeleteHeadlinesFromPersonalFeed3.png)

![](DeleteHeadlinesFromPersonalFeed4.png)

![](DeleteHeadlinesFromPersonalFeed5.png)

![](DeleteHeadlinesFromPersonalFeed6.png)
...
![](CreateIndividualHeadlinePage.png)

![](CreateIndividualHeadlinePage2.png)
...
![](SaveAndDisplayIndividualHeadlines.png)

![](SaveAndDisplayIndividualHeadlines2.png)

![](SaveAndDisplayIndividualHeadlines3.png)
...
![](AddAbilityToSendComments.png)

![](AddAbilityToSendComments2.png)

![](AddAbilityToSendComments3.png)
...
![](LikeCommentsAndOrderCommentsByLikeCount.png)

![](LikeCommentsAndOrderCommentsByLikeCount2.png)

![](LikeCommentsAndOrderCommentsByLikeCount3.png)

![](LikeCommentsAndOrderCommentsByLikeCount4.png)

![](LikeCommentsAndOrderCommentsByLikeCount5.png)

![](LikeCommentsAndOrderCommentsByLikeCount6.png)
...
![](GetHeadlinesByNewsSource.png)

![](GetHeadlinesByNewsSource2.png)
...
![](QueryHeadlinesBySearchTerms.png)

![](QueryHeadlinesBySearchTerms2.png)

![](QueryHeadlinesBySearchTerms3.png)

- The error is because with the free News API version we can Search articles up to a month old.

![](QueryHeadlinesBySearchTerms4.png)

![](QueryHeadlinesBySearchTerms5.png)
...
![](UseDateFnsAndVueFiltersToFormatHeadline.png)

![](UseDateFnsAndVueFiltersToFormatHeadline2.png)

![](UseDateFnsAndVueFiltersToFormatHeadline3.png)

![](UseDateFnsAndVueFiltersToFormatHeadline4.png)

![](UseDateFnsAndVueFiltersToFormatHeadline5.png)
...
![](UseCssTransitionsUponRouteChange.png)

![](UseCssTransitionsUponRouteChange2.png)

![](UseCssTransitionsUponRouteChange3.png)
...
![](AddDefaultImageToHeadlinesWithoutMedia.png)
...
![](AddDefaultImageToHeadlinesWithoutMedia2.png)
...
![](AddDefaultImageToHeadlinesWithoutMedia3.png)
...
![](AddDefaultImageToHeadlinesWithoutMedia4.png)

![](AddDefaultImageToHeadlinesWithoutMedia5.png)
...
![](AddDefaultImageToHeadlinesWithoutMedia6.png)

![](AddDefaultImageToHeadlinesWithoutMedia7.png)

![](AddDefaultImageToHeadlinesWithoutMedia8.png)

![](AddDefaultImageToHeadlinesWithoutMedia9.png)
...
![](SeamlessAppDeploymentWithHeroku.png)

![](SeamlessAppDeploymentWithHeroku2.png)

![](SeamlessAppDeploymentWithHeroku3.png)

- Log in to `Heroku`

![](SeamlessAppDeploymentWithHeroku4.png)

- Click on [New]

![](SeamlessAppDeploymentWithHeroku5.png)

![](SeamlessAppDeploymentWithHeroku6.png)

- Put `nuxt-news-peelmicro` for `App name` and then click on `Create app`

![](SeamlessAppDeploymentWithHeroku7.png)
...
![](SeamlessAppDeploymentWithHeroku8.png)

![](SeamlessAppDeploymentWithHeroku9.png)
...
![](SeamlessAppDeploymentWithHeroku10.png)

![](SeamlessAppDeploymentWithHeroku11.png)

![](SeamlessAppDeploymentWithHeroku12.png)
...
![](SeamlessAppDeploymentWithHeroku13.png)
...
![](SeamlessAppDeploymentWithHeroku14.png)
...
![](SeamlessAppDeploymentWithHeroku15.png)

![](SeamlessAppDeploymentWithHeroku16.png)

![](SeamlessAppDeploymentWithHeroku17.png)

![](SeamlessAppDeploymentWithHeroku18.png)

![](SeamlessAppDeploymentWithHeroku19.png)

![](SeamlessAppDeploymentWithHeroku20.png)

![](SeamlessAppDeploymentWithHeroku21.png)

![](SeamlessAppDeploymentWithHeroku22.png)
